...
namespace EcoBuilder.UI
{
    public class Score : MonoBehaviour
    {
        ...
        public void Finish()
        {
            ...
            StartCoroutine(Tweens.Pivot(GetComponent<RectTransform>(), new Vector2(0,.5f), new Vector2(0,0), 1, ()=>GetComponent<Canvas>().enabled=false));
        }
        ...
        public void Hide(bool hidden=true)
        {
            ...
            if (!hidden) {
                StartCoroutine(Tweens.Pivot(GetComponent<RectTransform>(), new Vector2(0,0), new Vector2(0,.5f)));
            }
        }
    }
}